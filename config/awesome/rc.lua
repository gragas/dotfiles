...
-- {{{ Tags
tags = {
   names = { "develop1", "develop2", "web", "other"},
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ altkey, "Shift"   }, "n",      function () awful.tag.incmwfact( 0.05)     end),
    awful.key({ altkey, "Shift"   }, "p",      function () awful.tag.incmwfact(-0.05)     end),
