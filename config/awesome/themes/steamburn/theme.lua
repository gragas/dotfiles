...
theme.fg_normal                     = "#FFFFFF"--"#e2ccb0"
theme.fg_focus                      = "#d88166"
theme.fg_urgent                     = "#CC9393"
theme.bg_normal                     = "#001122"--"#140c0b"
theme.bg_focus                      = "#001122"--"#140c0b"
theme.bg_urgent                     = "#001122"--"#2a1f1e"
theme.border_width                  = 1
theme.border_normal                 = "#302627"
theme.border_focus                  = "#0077FF"--"#c2745b"
theme.border_marked                 = "#00FFFF"--"#CC9393"
theme.taglist_fg_focus              = "#0077FF"--"#d88166"
theme.tasklist_bg_focus             = "#001122"--"#140c0b"
theme.tasklist_fg_focus             = "#0077FF"--"#d88166"
